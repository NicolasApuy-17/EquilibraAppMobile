...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? HomeScreenWidget() : TestScreenWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: Grounding54321Widget.routeName,
          path: Grounding54321Widget.routePath,
          requireAuth: true,
          builder: (context, params) => Grounding54321Widget(),
        ),
        FFRoute(
          name: BreathingGuidedWidget.routeName,
          path: BreathingGuidedWidget.routePath,
          requireAuth: true,
          builder: (context, params) => BreathingGuidedWidget(),
        ),
        FFRoute(
          name: FindTheColorWidget.routeName,
          path: FindTheColorWidget.routePath,
          requireAuth: true,
          builder: (context, params) => FindTheColorWidget(),
        ),
        FFRoute(
          name: SoundFocusWidget.routeName,
          path: SoundFocusWidget.routePath,
          requireAuth: true,
          builder: (context, params) => SoundFocusWidget(),
        ),
        FFRoute(
          name: MindfulVibrationWidget.routeName,
          path: MindfulVibrationWidget.routePath,
          requireAuth: true,
          builder: (context, params) => MindfulVibrationWidget(),
        ),
        FFRoute(
          name: MindfulObservationWidget.routeName,
          path: MindfulObservationWidget.routePath,
          requireAuth: true,
          builder: (context, params) => MindfulObservationWidget(),
        ),
        FFRoute(
          name: BreathingVisualWidget.routeName,
          path: BreathingVisualWidget.routePath,
          requireAuth: true,
          builder: (context, params) => BreathingVisualWidget(),
        ),
        FFRoute(
